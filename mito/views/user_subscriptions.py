...
@login_required
def index():
    user_subscription, error = user_subscriptions_service.get_subscriptions_for_user(current_user.id)
    ...
    return LayoutSR(
        ...
        Component('user-subscriptions', user_subscriptions_page.render_user_subscription, user_subscription=user_subscription),
